...
def flatten(li) -> list:
    '''
    flatten a irregular list recursively; write for flattening multiple levels of outlines.
    '''
...
def get_auditor(indpt_audit_report, p):
    ...
    auditor = re.search(pattern, text)
    print(auditor.group('auditor'))
    return auditor
...
# url = 'https://www1.hkexnews.hk/listedco/listconews/sehk/2020/0716/2020071600886.pdf'
url = 'https://www1.hkexnews.hk/listedco/listconews/sehk/2020/0728/2020072800460.pdf'
pdf = get_pdf(url)
# print(pdf.getNamedDestinations())
pages = pdf.getNumPages()
iar, il = "INDEPENDENT AUDITOR'S REPORT", []
...
get_auditor(pdf, 112)
# print(pdf.getPage(110).extractText())
# get_outline_with_page_num(pdf)
...
#     print(outline)
#     print(pdf.getDestinationPageNumber(outline))
